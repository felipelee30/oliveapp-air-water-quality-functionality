...
export const CollapsedView: React.FC<CollapsedViewProps> = ({ data, onExpand }) => {
  return (
    <TouchableOpacity onPress={onExpand} activeOpacity={0.9}>
      ...
      >
        ...
        <View className="flex-row justify-between items-center">
          ...
          <View className="flex-1 mr-4">
              <View className="flex-row items-center mb-2">
                ...
                <View>
                  <Text className="text-gray-900 font-semibold text-sm">Tap water</Text>
            ...
            {/* Divider */}
            <View className="w-px h-16 bg-glass-white-20 mx-2" />
            ...
            <View className="flex-1 ml-4">
              <View className="flex-row items-center mb-2">
                ...
                <View>
                  <Text className="text-gray-900 font-semibold text-sm">Air quality</Text>
                  <Text className="text-gray-600 text-xs">
        ...
        <View className="mt-3 flex-row justify-center">
          <View className="w-10 h-1 bg-glass-white-20 rounded-full" />
        </View>
        </View>
      </BlurView>
    </TouchableOpacity>
