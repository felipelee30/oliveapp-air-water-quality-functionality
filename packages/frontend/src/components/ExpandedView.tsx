...
export const ExpandedView: React.FC<ExpandedViewProps> = ({
  ...
  return (
    <SafeAreaView className="flex-1" edges={["top"]}>
      <BlurView intensity={60} tint="light" className="flex-1 rounded-3xl">
            ...
            <View className="p-4">
              ...
              <View className="mb-6">
                ...
                <View className="flex-row mb-4">
                  ...
                  <View className="flex-1 ml-2">
                    <View className="bg-glass-white-20 rounded-lg p-4 border-2 border-glass-white-30 shadow-lg flex-1">
                      <View className="flex-row items-center mb-2">
              ...
              <View className="mb-6">
                ...
                <View className="bg-glass-white-15 rounded-lg p-4 border-2 border-glass-white-25 shadow-md">
                  <Text className="text-gray-900 text-sm">
                    • Activated Carbon Filter - Removes chlorine and organic
                    compounds
                  </Text>
              ...
              <View className="mb-6">
                ...
                <View className="bg-glass-white-15 rounded-lg p-4 border-2 border-glass-white-25 shadow-md">
                  <Text className="text-gray-900 text-sm mb-2">
                    <Text className="font-medium">Air Quality:</Text> Based on
                    Air Quality Index (AQI) and pollutant concentrations vs. WHO
                    guidelines.
                  </Text>
                  <Text className="text-gray-900 text-sm">
                    <Text className="font-medium">Water Quality:</Text> Based on
                    contaminant levels vs. EPA maximum contaminant levels (MCL).
                  </Text>
                </View>
              </View>
              ...
              <View className="mb-4">
                <Text className="text-gray-700 text-xs text-center">
                  Location: {data.coordinates.latitude.toFixed(4)},{" "}
